...
.sidebar-link i {
    color: #38bdf8 !important;  /* Color celeste para todos los iconos */
    transition: color 0.15s ease;
}
.sidebar-link:hover i {
    color: #7dd3fc !important;  /* Celeste más claro al hacer hover */
}
            ...
            children=[
                html.Div(style={'display': 'flex', 'gap': '22px', 'marginTop': '18px'}, children=[
                    ...
                    html.Div(style={'flex': '2'}, children=[
                        ...
                        # Gráfico 4: Relajación Tisular (ID ÚNICO: graph-relaxation-curves)
...
# ---- 5. CALLBACKS DE LA SIMULACIÓN (idénticos al original) ----
...
# ---- Glosario / contenido de los modales "clic para aprender más" ----
...
def page_inicio():
    return html.Div(style=STYLE_CONTAINER, children=[
        ...
        edu_card("¿Qué es la Resonancia Magnética?", "", [
            ...
            # ===== IMAGEN INSERTADA ANTES DE "En resumen" =====
...
def page_kspace():
    return html.Div(style=STYLE_CONTAINER, children=[
        ...
        html.Div(style={'display': 'flex', 'flexWrap': 'wrap', 'gap': '20px', 'marginBottom': '22px', 'alignItems': 'stretch'}, children=[
            ...
            # ===== COLUMNA DERECHA: una tarjeta grande que ocupa toda la altura =====
...
def render_page(pathname):
    ...
    elif pathname == '/actividades':  # ← NUEVA
